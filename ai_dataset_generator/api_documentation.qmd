...
| `seasonality_multipliers` | array | No | Seasonal multipliers for time series |
...
2. Apply seasonality: `target_value × seasonality_multipliers[row_index % period]`
3. Add noise (after seasonality)
...
12. **Seasonality multipliers** are numeric values
...
- **Seasonality**: Applied to target after expression evaluation but before noise
- **Time series**: Lagged features are automatically created and available in expressions
- **Datetime features**:
